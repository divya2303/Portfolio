...
$(document).ready(function() {
  ...
  $('#about-flters li').on('click', function() {
    ...
    $('.about-me').fadeTo(100, 0);

    $('.filter-intro, .filter-interests, .filter-skills').fadeOut().css('transform', 'scale(0)');
...
//   // Optional: Add a class to clickable elements for cursor interaction
